...
class DefaultJwtTokenPairCreator implements JwtTokenPairCreator {
    ...
    DefaultJwtTokenPairCreator(Algorithm algorithm,
                               Clock clock,
    ...
    public ApiJsonWebTokenPair create(JwtCreateRequest jwtCreateRequest) {
        ...
        final var accessToken = createAccessToken(jwtCreateRequest, now);
        final var refreshToken = createRefreshToken(accessToken, now);

        return new ApiJsonWebTokenPair(accessToken, refreshToken);
    }

    private ApiJsonWebToken createAccessToken(JwtCreateRequest jwtCreateRequest, ZonedDateTime now) {
    ...
    private ApiJsonWebToken createRefreshToken(ApiJsonWebToken accessToken, ZonedDateTime now) {
